...
export const SCANNER_KEY =
	process.env.SCANNER_KEY || '0xb7ad1bcb86dced081b9cca266d85fdcacd19da742be2f8537957e591e07eb5ea';
...
export const CustomType = {
	...
	DeviceState: {
		_enum: ['Unmount', 'Stop', 'Standby', 'Offline', 'Serving', 'TryExit']
	},
	StakingState: {
		user: 'AccountId',
		locked: 'Balance',
	...
	CommitteeId: 'u32',
	CommitteeState: {
		_enum: ['Creating', 'Initializing', 'Stop', 'Working', 'CreateFinished']
	},
	ChannelState: {
		_enum: ['Stop', 'Working']
	},
	...
	CryptoType: {
		_enum: ['Ecdsa', 'Bls', 'Schnorr']
	},
	Source: {
		_enum: ['Mining', 'Serving']
	},
	Channel: {
		channel_id: 'u32',
		creator: 'AccountId',
	...
	TxStatus: {
		_enum: ['Unsigned', 'Finished', 'Abnormal', 'Drop']
	},
	BtcTxTunnel: {
		_enum: ['Empty', 'Verifying', 'Open']
	},
	ConfirmType: {
		_enum: ['SourceHash', 'TxData']
	},
	DstChainType: {
		_enum: ['Raw', 'Fil', 'Bsc', 'BtcMainnet', 'Eth', 'BtcTestnet']
	}
};
